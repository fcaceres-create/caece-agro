    ...
    with st.sidebar:
        ...
        with st.expander("📚 Acerca del proyecto", expanded=False):
            st.markdown(
                ...
                "(https://github.com/fcaceres-create/caece-agro/blob/main/notebooks/02_eda_consolidado.ipynb)\n"
                "- 📓 [Bitácora del proyecto]"
                "(https://github.com/fcaceres-create/caece-agro/blob/main/docs/recuperacion_de_datos.md)\n"
                "\n"
                "---\n"
                "\n"
                "### Sistema\n"
